...
//
// Login page — mirrors the pluto-terminal design.
// Calls onLogin() on successful sign-in to hand control back to App.tsx.

import { useState } from "react";
import "./LoginPage.css";
import tqtLogo from "../assets/tqt-logo-for-dark-background.png";
import tqtBull from "../assets/tqt-bull-mascot.png";
...
export default function LoginPage({ onLogin }: LoginPageProps) {
  ...
  const handleSignIn = (e: React.FormEvent) => {
    e.preventDefault();
    // TODO: wire up real auth — for now, any submit navigates to the dashboard
    onLogin();
  };
